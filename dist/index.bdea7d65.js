...
const ball = new _ball.Ball(document.getElementById('ball'));
const game = new _game.Game();
const playerPaddle = new _paddle.Paddle(document.getElementById('player-paddle'));
const enemyPaddle = new _paddle.Paddle(document.getElementById('enemy-paddle'));
...
function LoseHandler() {
    ...
    if (game.isGameEnded()) window.location.reload();
    playerPaddle.reset();
    enemyPaddle.reset();
    ball.reset();
}

},{"./Ball":"ajUWd","./Paddle":"6flHN","./Game":"fJoK3"}],"ajUWd":[function(require,module,exports) {
...
class Ball {
    ...
    update(delta, paddleRects) {
        ...
        if (rect.bottom >= innerHeight || rect.top <= 0) this.direction.y *= -1;
...
},{}],"6flHN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fJoK3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Game {
    checkWin() {
        if (this.player_score > 11) this.playerWin = true;
    }
    checkLose() {
        if (this.enemy_score > 11) this.enemyWin = true;
    }
    get playerScore() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["hMwtF","7PGg5"], "7PGg5", "parcelRequire94c2")
